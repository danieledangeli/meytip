...
class QuoteFinale {
    ...
    protected $nopodio;
     ...
     /**
     *
     * @ORM\ManyToOne(targetEntity="Team", inversedBy="finalequotes")
     ...
     * @return QuoteFinale
     */
    public function setPodio($podio)
    {
        $this->podio = $podio;
     ...
     * @return QuoteFinale
     */
    public function setNopodio($nopodio)
    {
        $this->nopodio = $nopodio;
